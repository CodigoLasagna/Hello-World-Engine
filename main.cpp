/*Plantillas*/
//#include "templates/formatoBasico/main.cpp" //proyecto de explicación para el formato básico (sistema viejo)
//#include "templates/newloopOldsys/main.cpp" //ejemplo de loop nuevo con (sistema viejo)
